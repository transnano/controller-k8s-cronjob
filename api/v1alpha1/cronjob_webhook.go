...
// +kubebuilder:webhook:path=/mutate-batch-transnano-net-v1alpha1-cronjob,mutating=true,failurePolicy=fail,groups=batch.transnano.net,resources=cronjobs,verbs=create;update,versions=v1alpha1,name=mcronjob.kb.io
...
// +kubebuilder:webhook:verbs=create;update,path=/validate-batch-transnano-net-v1alpha1-cronjob,mutating=false,failurePolicy=fail,groups=batch.transnano.net,resources=cronjobs,versions=v1alpha1,name=vcronjob.kb.io
...
func (r *CronJob) validateCronJob() error {
	...
	return apierrors.NewInvalid(
		schema.GroupKind{Group: "batch.transnano.net", Kind: "CronJob"},
		r.Name, allErrs)
}
